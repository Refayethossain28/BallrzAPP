...
(function (root) {
  ...
  function ptNum(n) {
    ...
    if (t) parts.push(t === 1 ? 'mil' : ptSub1000(t) + ' mil');
  ...
  function itNum(n) {
    ...
    if (rest) {
      ...
      if (t) {
        ...
        word = (t === 1 ? 'mille' : mult + 'mila') + (r ? itSub1000(r) : '');
  ...
  (function () {
    ...
    SCRIPT_REFINE.devanagari = function (text) {
      return /[ळऱॲ]|आहे/.test(text) ? 'mr' : 'hi';
    };
