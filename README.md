...
- **⭐ [Omni — do-everything app](https://refayethossain28.github.io/BallrzAPP/omni/)** — one offline-first home for your day: tasks, notes, calculator, unit/currency converter, timers & pomodoro, habit streaks, money log, text tools, password generator and a world clock — with a ⌘K command palette to jump anywhere. No account, no cloud, **installable PWA**, everything stored on-device.
