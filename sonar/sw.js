/* Offline service worker for Sonar. One HTML file + the engine, so navigations
 ...
 * speed. The ask API (/api/) is never cached — live answers stay live. Bump
...
self.addEventListener('fetch', (e) => {
  ...
  if (url.pathname.includes('/api/') || url.origin !== self.location.origin) return; // live answers stay live
