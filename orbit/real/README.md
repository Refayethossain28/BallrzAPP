...
The **real version** of Orbit, living beside [the demo](../). No fictional
city, no simulated fleet, no play money:
...
npm run test:orbit           # 64 engine tests (shared engine with the demo)
```
