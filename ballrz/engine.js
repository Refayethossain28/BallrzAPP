...
(function (root) {
  ...
  var CLUBS = [
    { name: 'Rivergate United',   short: 'RIV', color: '#e0393f', color2: '#8e1c22', tier: 1 },
    { name: 'Harbour City',       short: 'HBC', color: '#5cb8ff', color2: '#1f6cb0', tier: 1 },
    { name: 'Ironbridge Athletic',short: 'IRO', color: '#a33757', color2: '#5ce0ff', tier: 1 },
    { name: 'Kings Cross Rovers', short: 'KCR', color: '#3f5fe0', color2: '#1c2f8e', tier: 1 },
    { name: 'Northfield Forest',  short: 'NFF', color: '#2fae5f', color2: '#186338', tier: 2 },
    { name: 'Saint Brides FC',    short: 'STB', color: '#9b5ce0', color2: '#54258e', tier: 2 },
    { name: 'Westport Wanderers', short: 'WPW', color: '#e0b83f', color2: '#8e701c', tier: 2 },
    { name: 'Oakmoor Town',       short: 'OAK', color: '#e0783f', color2: '#8e441c', tier: 2 },
    { name: 'Silverlake Albion',  short: 'SLA', color: '#cbd5e1', color2: '#64748b', tier: 2 },
    { name: 'Redstone Rangers',   short: 'RED', color: '#d94f6b', color2: '#87263c', tier: 2 },
    { name: 'Eastvale FC',        short: 'EAS', color: '#35c4b5', color2: '#177168', tier: 3 },
    { name: 'Mill Lane County',   short: 'MLC', color: '#4f6bd9', color2: '#263c87', tier: 3 },
    { name: 'Foxglove Borough',   short: 'FOX', color: '#e09b3f', color2: '#8e5c1c', tier: 3 },
    { name: 'Anchor Bay',         short: 'ANC', color: '#3fc4e0', color2: '#1c748e', tier: 3 },
    { name: 'Granite City',       short: 'GRA', color: '#8fa3b8', color2: '#4a5a6b', tier: 3 },
    { name: 'Thornbury FC',       short: 'THO', color: '#a3d94f', color2: '#5c8726', tier: 3 },
    { name: 'Larkspur Athletic',  short: 'LRK', color: '#b04fd9', color2: '#632687', tier: 4 },
    { name: 'Copperfield Town',   short: 'COP', color: '#c98a52', color2: '#7a4e26', tier: 4 },
    { name: 'Brambleton FC',      short: 'BRM', color: '#d9779b', color2: '#873c5c', tier: 4 },
    { name: 'Dockside United',    short: 'DOC', color: '#6b93c9', color2: '#33517a', tier: 4 },
  ];
